...
export declare const useCamera: ({ sizes }: Pick<TresContext, "sizes"> & {
    ...
    cameras: import('vue').Ref<{
        ...
        parent: {
            ...
            onBeforeShadow: (renderer: import('three').WebGLRenderer, scene: import('three').Scene, camera: Camera, shadowCamera: Camera, geometry: import('three').BufferGeometry, depthMaterial: import('three').Material, group: import('three').Group) => void;
            onAfterShadow: (renderer: import('three').WebGLRenderer, scene: import('three').Scene, camera: Camera, shadowCamera: Camera, geometry: import('three').BufferGeometry, depthMaterial: import('three').Material, group: import('three').Group) => void;
            ...
            addEventListener: <T extends keyof import('three').Object3DEventMap>(type: T, listener: import('three').EventListener<import('three').Object3DEventMap[T], T, import('three').Object3D<import('three').Object3DEventMap>>) => void;
            hasEventListener: <T extends keyof import('three').Object3DEventMap>(type: T, listener: import('three').EventListener<import('three').Object3DEventMap[T], T, import('three').Object3D<import('three').Object3DEventMap>>) => boolean;
            removeEventListener: <T extends keyof import('three').Object3DEventMap>(type: T, listener: import('three').EventListener<import('three').Object3DEventMap[T], T, import('three').Object3D<import('three').Object3DEventMap>>) => void;
        ...
        addEventListener: <T extends keyof import('three').Object3DEventMap>(type: T, listener: import('three').EventListener<import('three').Object3DEventMap[T], T, Camera>) => void;
        hasEventListener: <T extends keyof import('three').Object3DEventMap>(type: T, listener: import('three').EventListener<import('three').Object3DEventMap[T], T, Camera>) => boolean;
        removeEventListener: <T extends keyof import('three').Object3DEventMap>(type: T, listener: import('three').EventListener<import('three').Object3DEventMap[T], T, Camera>) => void;
        dispatchEvent: <T extends keyof import('three').Object3DEventMap>(event: import('three').BaseEvent<T> & import('three').Object3DEventMap[T]) => void;
    }[], Camera[] | {
        readonly isCamera: true;
        readonly type: string | "Camera";
