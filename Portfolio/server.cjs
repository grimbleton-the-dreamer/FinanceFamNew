...
var pg_1 = require("pg"); // Default import for 'pg' (PostgreSQL module)
var Pool = pg_1.default.Pool; // Destructure Pool and PoolClient from the default import
...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var client, rows, currentUser, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                client = _a.sent();
                return [4 /*yield*/, client.query('SELECT user')];
            case 2:
                rows = (_a.sent()).rows;
                currentUser = rows[0]['user'];
                console.log("Connected as: ".concat(currentUser));
                return [3 /*break*/, 5];
            case 3:
                err_1 = _a.sent();
